              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>If 100 Agents: Estimated time ~{{ Math.round(customMaxRounds * 0.6) }} mins</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        If 100 Agents: Estimated time ~{{ Math.round(autoGeneratedRounds * 0.6) }} mins
                      </span>
                    </div>
                    <div class="auto-desc">
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    ...
    addLog(`Starting simulation, custom rounds: ${customMaxRounds.value} 轮`)
  } else {
    // 用户选择保持自动生成的轮数，不传递 max_rounds 参数
    addLog(`Starting simulation, auto-generated rounds: ${autoGeneratedRounds.value} 轮`)
  }
