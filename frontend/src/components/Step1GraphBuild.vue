    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM analyzes document content and simulation requirements to extract reality seeds and automatically generate suitable ontology structure.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, automatically chunk documents, build knowledge graph locally using NetworkX and Ollama LLM, extract entities and relations, and form episodic memory.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Graph build is completed. Please proceed to the next step to set up the simulation environment.</p>
          <button 
            class="action-btn" 
          ...
          >
            ...
            {{ creatingSimulation ? 'Creating...' : 'Environment Setup ➝' }}
          </button>
        </div>
      </div>
    </div>
...
const handleEnterEnvSetup = async () => {
  if (!props.projectData?.project_id || !props.projectData?.graph_id) {
    console.error('Missing project or graph ID')
    return
  }
  ...
  try {
    // In SwarmIQ, Simulation project is synonymous with Graph project
    router.push({
      name: 'Simulation',
      params: { simulationId: props.projectData.project_id }
    })
  } catch (err) {
