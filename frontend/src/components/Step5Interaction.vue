          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">Select Agent to Chat</div>
                <div 
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">A fast chat version of the report agent, capable of calling 4 professional tools, and possessing SwarmIQ's full memory.</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seed data with the simulated state, combining Global/Local Memory to provide deep cross-spatiotemporal attribution analysis.</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Graph-based breadth-first traversal reconstructing event propagation and capturing topological information flow structures.</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-powered real-time query interface to rapidly extract specific node attributes and discrete facts.</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous multi-round interviews directly with simulated individuals. Collects unstructured opinion data and mental states on demand.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with the Report Agent to dive deeper into the report.' : 'Chat with a simulated individual to understand their perspective.' }}
              </p>
            </div>
            <div 
...
const submitSurvey = async () => {
  ...
  try {
    ...
    addLog(`Failed to send survey: ${err.message}`)
  } finally {
