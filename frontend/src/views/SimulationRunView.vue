    ...
    <header class="app-header">
      ...
      <div class="header-right">
        <div class="workflow-step">
          ...
          <span class="step-name">Run Engine</span>
        </div>
...
const numAgents = ref(route.query.numAgents ? parseInt(route.query.numAgents) : 5)
...
const handleNextStep = () => {
  addLog('Entering Step 4: Analytics Report')
}
...
const stopGraphRefresh = () => {
  if (graphRefreshTimer) {
    ...
    addLog('Disabled live graph refresh')
  }
}
...
onMounted(() => {
  ...
  if (maxRounds.value) {
    addLog(`Custom engine ticks: ${maxRounds.value}`)
  }
